...
/**
 * GameOverPanel - Displays the game over screen with visual feedback.
 * 
 * Responsibilities:
 * - Manages game over screen UI and visibility
 * - Plays dramatic scale pulse animation when game ends
